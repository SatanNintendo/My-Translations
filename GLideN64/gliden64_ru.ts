...
<context>
    ...
    <message>
        ...
        <translation>О GLideN64</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Графический плагин нового поколения с открытым исходным кодом для эмуляторов N64.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Бета-тестер</translation>
    </message>
    <message>
        <location filename="AboutDialog.ui" line="193"/>
        <source>GUI designer</source>
        <translation>Дизайнер графического интерфейса</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translatorcomment>Относится к большему количеству спонсоров</translatorcomment>
...
<context>
    ...
    <message>
        ...
        <translation>Оконное разрешение:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Этот параметр выбирает разрешение для оконного режима. Вы также можете ввести пользовательский размер окна.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot;стиль шрифта:курсив;&quot;&gt;640 x 480, 800 x 600, 1024 x 768, 1280 x 960&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Потоковое видео может улучшить производительность при использовании плохих драйверов OpenGL за счет очень незначительной задержки ввода, обычно менее половины кадра.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Обычно выключено, если нет проблем с производительностью&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="219"/>
        <source>Enable threaded video</source>
        <translation>Включить потоковое видео</translation>
    </message>
    <message>
        ...
        <translation>При включении изображение обрезается по значениям, указанным в пикселях N64. Полезно для удаления черных полей в некоторых играх.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;GLideN64 предлагает два метода сглаживания неровных полигонов:&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Быстрое приблизительное сглаживание (FXAA)&lt;/span&gt;: FXAA — это фильтр постобработки, который может обеспечить приличный результат, но такой же хороший, как MSAA. Основная причина использования FXAA — использование с &lt;span style=&quot; font-weight:600;&quot;&gt;сравнением глубины в стиле N64&lt;/span&gt;. FXAA добавляет некоторую размытость к выходному изображению, из-за чего некоторые текстуры, такие как текст, могут выглядеть хуже.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Мультисэмпловое сглаживание (MSAA)&lt;/span&gt;: MSAA — это стандартный метод сглаживания, используемый в компьютерной графике для улучшения качества изображения. Большинство современных графических процессоров поддерживают 2, 4, 8 и 16 выборок. Больше выборок означает лучшее качество, но работает медленнее. Есть два недостатка: он несовместим со &lt;span style=&quot; font-weight:600;&quot;&gt;сравнением глубины в стиле N64&lt;/span&gt; и может вызывать незначительные сбои в некоторых играх.&lt;/p&gt;&lt;p&gt;Рекомендация: [&lt;span style=&quot; font-style:italic;&quot;&gt;Обычно 16x MSAA или FXAA с сравнением глубины в стиле N64&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Быстрое приблизительное сглаживание (FXAA)</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="432"/>
        <source>Multisample anti-aliasing (MSAA):</source>
        <translation>Мультисэмпловое сглаживание (MSAA):</translation>
    </message>
    <message>
        ...
        <translation>Многовыборочное сглаживание несовместимо со сравнением глубины в стиле &lt;a href=&quot;#n64DepthCompare&quot;&gt;N64.&lt;/a&gt;.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Некоторые параметры на этой вкладке отключены, поскольку &lt;a href=&quot;#frameBuffer&quot;&gt;эмуляция буфера кадра&lt;/a&gt; отключена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Если включено, все нестандартные значения настроек сохраняются индивидуально для каждой игры.&lt;/p&gt;&lt;p&gt;Когда игра запущена, настройки отображаются и сохраняются для текущей запущенной игры.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Примечание:&lt;/span&gt; GLideN64 уже содержит настройки для оптимальной производительности большинства игр. Будьте осторожны при изменении параметров на вкладках «Эмуляция» и «Буфер кадров».&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Пользовательский уровень гамма-коррекции:</translation>
    </message>
    <message>
        ...
        <translation>Выбор этого параметра отменяет гамма-коррекцию, заданную игрой.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Как и в реальном оборудовании, эта настройка уменьшает количество цветов, если используется дизеринг. Удаляет нежелательные фрагменты дизеринга. По умолчанию = включено..&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1395"/>
        <source>Enable 5bit quantization</source>
        <translation>Включить 5-битное квантование</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта настройка удваивает разрешение шума, чтобы получить более четкий эффект шума при более высоких разрешениях. По умолчанию = отключено.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1405"/>
        <source>High resolution noise dithering</source>
        <translation>Сглаживание шума с высоким разрешением</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Этот параметр включает контролируемое игрой упорядоченное сглаживание сетки. Включите его для точного представления. По умолчанию = отключено.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1415"/>
        <source>Dithering pattern on output image</source>
        <translation>Размытый узор на выходном изображении</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Дизеринг RDRAM предотвращает появление цветных полос в играх с эффектами кадрового буфера.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1427"/>
        <source>RDRAM image dithering:</source>
        <translation>Дизеринг изображения RDRAM:</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Настройки: Отключено, Дизеринг по матрице Байера, Дизеринг по матрице &quot;Магический квадрат&quot; или дизеринг по синему шуму. Дизеринг по синему шуму даёт наименее заметные результаты. По умолчанию: дизеринг по синему шуму.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Фон — это сложная макрокоманда, используемая для отрисовки больших (обычно полноэкранных) изображений. Поскольку фоновые изображения обычно не помещаются в текстурную память, микрокод разделяет их на узкие полосы и отрисовывает одну за другой. Код HLE имеет два режима для эмуляции команд фона:&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Одним куском&lt;/span&gt;: Всё фоновое изображение отрисовывается как один текстурированный прямоугольник. Этот метод обычно намного быстрее, но результат не всегда корректен.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Полосами&lt;/span&gt;: Этот метод эмулирует команды фона максимально близко к фактической реализации микрокода. Он медленнее, но точнее. Другая проблема: в некоторых играх при высоком разрешении могут появляться пробелы между отрисованными полосами. Используйте опцию &amp;quot;Рендерить 2D-элементы в разрешении N64&amp;quot;, для удаления этих пробелов.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Зависит от игры, в основном &quot;Полосами&quot;&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1649"/>
        <source>Background rendering mode (HLE only):</source>
        <translation>Режим фонового рендеринга (только HLE):</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1656"/>
        <source>One piece</source>
        <translation>Одним куском</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1663"/>
        <source>Stripped</source>
        <translation>Полосами</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1789"/>
        <source>Emulate frame buffer</source>
        <translation>Эмулировать буфер кадра</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;N64 использует уникальный метод расчета глубины для камеры. При включении GlideN64 использует шейдеры, чтобы попытаться правильно эмулировать эти расчеты. Несовместимо со сглаживанием. &lt;span style=&quot; font-weight:600;&quot;&gt;Экспериментально!&lt;/span&gt;&lt;/p&gt;&lt;p&gt;Быстрый режим требует OpenGL 4.2 и расширения &amp;quot;fragment shader interlock&amp;quot;.&lt;/p&gt;&lt;p&gt;Совместимый режим требует только основной OpenGL 4.2 &lt;span style=&quot; font-weight:600;&quot;&gt;Может быть медленным!&lt;/span&gt;&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Иногда включено для нескольких игр&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2136"/>
        <source>N64-style depth compare (experimental, disables MSAA)</source>
        <translation>Сравнение глубины в стиле N64 (экспериментальное, отключает MSAA)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция включает альтернативное хранилище для текстур высокого разрешения.&lt;/p&gt;&lt;p&gt;Обычно используется кэш памяти. Он хранит все текстуры высокого разрешения в ОЗУ и, таким образом, ограничен доступным размером ОЗУ.&lt;/p&gt;&lt;p&gt;Файловое хранилище хранит кэш текстур на жестком диске. Он медленнее, чем кэш памяти, но практически не имеет ограничений по размеру кэша.&lt;/p&gt;&lt;p&gt;Отключите опцию «Сжать кэш текстур» для лучшей производительности.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция выгружает текстуры на экран в папку пакета текстур. &lt;/p&gt;&lt;p&gt;Горячая клавиша:&lt;br/&gt;Используйте &lt;span style=&quot; font-weight:600;&quot;&gt;D&lt;/span&gt; для включения или выключения выгрузки текстур&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2699"/>
        <source>Press &apos;d&apos; to dump N64 textures (for texture artists)</source>
        <translation>Нажмите «d», чтобы выгрузить текстуры N64 (для художников по текстурам)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция позволяет художникам по текстурам перезагружать текстуры высокого разрешения во время работы игры, чтобы мгновенно увидеть, как они выглядят — большая экономия времени!&lt;/p&gt;&lt;p&gt;Горячая клавиша:&lt;br/&gt;Используйте &lt;span style=&quot; font-weight:600;&quot;&gt;R&lt;/span&gt; для перезагрузки текстур из пакета текстур&lt;br/&gt;&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2709"/>
        <source>Press &apos;r&apos; to reload hi-res textures (for texture artists)</source>
        <translation>Нажмите «r», чтобы перезагрузить текстуры высокого разрешения (для художников по текстурам)</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="3350"/>
        <source>Display FPS</source>
        <translation>Отображать FPS</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="3357"/>
        <source>Display VI/s</source>
        <translation>Отображать VI/s</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="3371"/>
        <source>Display internal resolution</source>
        <translation>Внутреннее разрешение дисплея</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="3378"/>
        <source>Display rendering resolution</source>
        <translation>Разрешение рендеринга дисплея</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translatorcomment>Размер шрифта</translatorcomment>
    ...
    <message>
        ...
        <translatorcomment>Сокращение от font size pixels (размер шрифта в пикселях); при необходимости добавьте начальный пробел.</translatorcomment>
    ...
    <message>
        ...
        <translation>Предварительный просмотр шрифта показывает только обычный стиль для семейства шрифтов. Некоторые стили, такие как жирный и курсив, отображаются только в игре.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Улучшение текстур</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Использовать пакет текстур</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translatorcomment>В раскрывающемся списке разрешений оконного режима</translatorcomment>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Снятие этого параметра отключает многие эффекты, включая обрезку, соотношение сторон, коэффициент разрешения N64, сравнение глубины в стиле N64 и многое другое. Не снимайте этот параметр, если у вас нет проблем с производительностью.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translatorcomment>&quot;Вертикальное прерывание&quot; часто сокращается до &quot;VI&quot;. Этот элемент управления представляет собой выпадающий список с надписью &quot;Frame buffer swap on:&quot;</translatorcomment>
        <translation>Вертикальное прерывание (рекомендуется, наименьшее количество проблем с игрой)</translation>
    </message>
    <message>
        ...
        <translatorcomment>&quot;VI&quot; означает &quot;вертикальное прерывание&quot;. Этот элемент управления представляет собой выпадающий список с надписью &quot;Frame buffer swap on:&quot;</translatorcomment>
        <translation>Изменение начала VI (быстрее, меньше игровых проблем)</translation>
    </message>
    <message>
        ...
        <translatorcomment>Этот элемент управления представляет собой выпадающий список с надписью «Замена буфера кадров на:».</translatorcomment>
        <translation>Изменение цветового буфера (самое быстрое, некоторые проблемы с игрой)</translation>
    </message>
    <message>
        ...
        <translatorcomment>Это выпадающий список с надписью «Копировать буфер кадров видеокарты в память N64».</translatorcomment>
        <translation>Никогда (самый быстрый, много проблем с игрой)</translation>
    </message>
    <message>
        ...
        <extracomment>This is a combobox option with the label &quot;Copy video card frame buffer to N64 memory&quot;.</extracomment>
        <translatorcomment>Это выпадающий список с надписью «Копировать буфер кадров видеокарты в память N64».</translatorcomment>
        <translation>Синхронный (самый медленный, наименьшее количество проблем с игрой)</translation>
    </message>
    <message>
        ...
        <extracomment>This is a combobox option with the label &quot;Copy video card frame buffer to N64 memory&quot;.</extracomment>
        <translatorcomment>Это выпадающий список с надписью «Копировать буфер кадров видеокарты в память N64».</translatorcomment>
        <translation>Асинхронный (быстрый, мало игровых проблем)</translation>
    </message>
    <message>
        ...
        <extracomment>This is a combobox option with the label &quot;Copy video card frame buffer to N64 memory&quot;.</extracomment>
        <translatorcomment>Это выпадающий список с надписью «Копировать буфер кадров видеокарты в память N64».</translatorcomment>
        <translation>Никогда (самый быстрый, больше всего проблем с игрой)</translation>
    </message>
    <message>
        ...
        <extracomment>This is a combobox option with the label &quot;Copy video card frame buffer to N64 memory&quot;.</extracomment>
        <translatorcomment>Это выпадающий список с надписью «Копировать буфер кадров видеокарты в память N64».</translatorcomment>
        <translation>Из VRAM (медленно, некоторые проблемы с игрой)</translation>
    </message>
    <message>
        ...
        <extracomment>This is a combobox option with the label &quot;Copy video card frame buffer to N64 memory&quot;.</extracomment>
        <translatorcomment>Это выпадающий список с надписью «Копировать буфер кадров видеокарты в память N64».</translatorcomment>
        <translation>Программно (быстро, меньше всего проблем с игрой)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Включите принудительную очистку буфера глубины. Исправление. Необходимо для Eikou no Saint Andrews.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot;стиль шрифта:курсив;&quot;&gt;выключено, за исключением Eikou no Saint Andrews&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2170"/>
        <source>Force depth buffer clear</source>
        <translation>Принудительная очистка буфера глубины</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2565"/>
        <source>Texture pack path:</source>
        <translation>Путь к пакету текстур:</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2751"/>
        <source>Size of memory cache for enhanced textures:</source>
        <translation>Размер кэш-памяти для расширенных текстур:</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2814"/>
        <source>Compress texture cache</source>
        <translation>Сжать кэш текстур</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="17"/>
        <location filename="ConfigDialog.cpp" line="900"/>
        <source>GLideN64 Settings</source>
        <translation>Настройки GLideN64</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Должны отображаться все разрешения, поддерживаемые вашей видеокартой/монитором.&lt;/p&gt;&lt;p&gt;[Рекомендуется:&lt;span style=&quot;стиль шрифта:курсив;&quot;&gt; Максимальное разрешение для вашего монитора, если не возникает проблем с производительностью&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Вертикальная синхронизация, или VSync, может улучшить изображение, синхронизируя частоту кадров игры с частотой обновления вашего монитора. Это предотвращает разрывы изображения, но может вызвать проблемы с производительностью.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Обычно выключено; включить, если есть проблемы с разрывами изображения&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта настройка регулирует соотношение сторон видеовыхода. Все игры N64 поддерживают формат&lt;span style=&quot; font-weight:600;&quot;&gt;4:3&lt;/span&gt;. Некоторые игры поддерживают &lt;span style=&quot; font-weight:600;&quot;&gt;16:9&lt;/span&gt; через свои внутриигровые настройки. Используйте &lt;span style=&quot; font-weight:600;&quot;&gt;Растянуть&lt;/span&gt;, чтобы заполнить экран без боковых или верхних/нижних полос.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Попробовать подогнать игру под размер&lt;/span&gt; Попытка подстройки игры старается подогнать игровое пространство без растягивания. Многие игры хорошо поддаются такой подстройке, но некоторые нет.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="172"/>
        <source>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Aspect ratio:&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</source>
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Соотношение сторон:&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="180"/>
        <source>4:3 (recommended)</source>
        <translation>4:3 (рекомендуется)</translation>
    </message>
    <message>
        ...
        <translatorcomment>Эта опция активирует широкоэкранный режим. Формулировка &quot;Попробуйте&quot; подразумевает, что это может не сработать, а формулировка &quot;настроить игру&quot; подразумевает, что эмуляция будет неточной.</translatorcomment>
        <translation>Попробуйте настроить игру так, чтобы она подходила</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translatorcomment>Наибольшее число из набора чисел</translatorcomment>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Билинейная фильтрация&lt;/span&gt;: Текстуры будут использовать стандартную билинейную фильтрацию в стиле ПК.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;N64-style 3 point&lt;/span&gt;: Текстуры будут фильтроваться больше как N64. Результат менее гладкий, но более точный.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translatorcomment>Трёхточечная билинейная фильтрация, используемая в Nintendo 64.</translatorcomment>
        <translation>N64-стиль с 3 точками</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2764"/>
        <source> MB</source>
        <extracomment>Megabytes</extracomment>
        <translatorcomment>Мегабайты</translatorcomment>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Выбранный язык будет отображаться после закрытия и повторного открытия этого окна.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;N64 использует уникальный метод мип-маппинга, который сложно воспроизвести правильно на ПК. Если этот параметр отмечен, он эмулирует мип-маппинг N64 с точностью. Если этот параметр отключён, некоторые игры будут иметь более резкие удаленные текстуры.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1126"/>
        <source>Enable N64-style mip-mapping</source>
        <translation>Включить мип-маппинг в стиле N64</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;В играх N64 освещение рассчитывается по вершинам. Эта опция включает затенение Фонга, которое обеспечивает более плавное и реалистичное освещение.&lt;br/&gt;&lt;br/&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Ваши предпочтения&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1139"/>
        <source>Enable per-pixel lighting (better quality, HLE only)</source>
        <translation>Включить попиксельное освещение (лучшее качество, только HLE)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Используйте постоянное хранилище для скомпилированных шейдерных программ.&lt;br/&gt;В каждой игре используется набор комбинаторов. Комбинатор — это уравнение, которое определяет, как построить выходной цвет из различных входных цветов. GLideN64 транслирует шейдеры и компилирует шейдерные программы на лету. Шейдеры большие и сложные. Если в игре используется несколько новых комбинаторов, компиляция новых шейдеров займет время и приведет к подтормаживанию. Если этот параметр включён, эти шейдеры сохраняются, чтобы не перекомпилироваться при следующем запуске игры.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1149"/>
        <source>Store compiled shaders for performance (recommended)</source>
        <translation>Сохранение скомпилированных шейдеров для повышения производительности (рекомендуется)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция устанавливает размер буфера рендеринга вывода. По умолчанию буфер рендеринга установлен на &lt;span style=&quot; font-weight:600;&quot;&gt;Такое же как разрешение вывода&lt;/span&gt;, но вы можете установить его на &lt;span style=&quot; font-weight:600;&quot;&gt;Оригинальное разрешение N64&lt;/span&gt; или &lt;span style=&quot; font-weight:600;&quot;&gt;Кратно разрешению N64&lt;/span&gt;.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1179"/>
        <source>Same as output resolution</source>
        <translation>Такое же как разрешение вывода</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1189"/>
        <source>Original N64 resolution (most accurate)</source>
        <translation>Оригинальное разрешение N64 (наиболее точное)</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1206"/>
        <source>Multiple of N64 resolution:</source>
        <translation>Кратно разрешению N64:</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Когда эта опция включена, 2D-элементы отображаются в разрешении N64 перед копированием их на вывод. Это обычно устраняет проблемы отображения с 2D-элементами, но может быть медленным. Эта опция использует эвристику для обнаружения смежных 2D-элементов, что работает не для каждой игры.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено, если у вас нет проблем с производительностью&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;В некоторых играх координаты частей 2D-элементов не выровнены: между соседними элементами есть разделение в полпикселя. При рендеринге в исходном разрешении N64 оно не видно, но при увеличении изображения появляются черные линии. Этот параметр пытается соединить эти 2D-элементы.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Для соседних 2D-элементов&lt;/span&gt;: применить коррекцию только к тем полигонам, которые в ней нуждаются. Выберите этот параметр для игр, в которых есть проблемы с черными линиями.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Всегда&lt;/span&gt;: применить коррекцию для каждого 2D-элемента. Выберите этот параметр, если &lt;span style=&quot; font-weight:600;&quot;&gt;Для смежных 2D-элементов&lt;/span&gt; не помогает.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Никогда&lt;/span&gt;: не пытается исправить черные линии между 2D-элементами.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Зависит от игры, в основном Никогда&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translatorcomment>2D-элементы, ранее называвшиеся texrects, обычно используются для титульных экранов или HUD.</translatorcomment>
        <translation>Исправить черные линии между 2D-элементами:</translation>
    </message>
    <message>
        ...
        <translatorcomment>Метка для этого элемента управления — «Исправить черные линии между 2D-элементами».</translatorcomment>
        <translation>Для смежных 2D-элементов</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Если этот параметр отмечен, вспомогательный буфер цвета копируется в память N64 сразу после завершения рендеринга в него. Этот параметр помогает правильно эмулировать эффекты буфера кадра в некоторых играх. Этот параметр может заметно снизить производительность.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Обычно выключено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>Копирование вспомогательных буферов цвета в память N64 (иногда медленно, меньше проблем с игрой)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Этот параметр управляет частотой обновления GLideN64 основного буфера кадров.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Вертикальное прерывание&lt;/span&gt;: Обновляет буфер как можно быстрее, каждое вертикальное прерывание в секунду (50 для игр PAL и 60 для игр NTSC). Этот параметр наиболее совместим. Используйте этот режим, если у вас нет проблем с производительностью.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Изменение начала VI&lt;/span&gt;: Изменение начала VI в соответствии с фактическим FPS игры. Игры N64 обычно работают со скоростью от 20 до 30 FPS, поэтому буферы меняются реже, чем в первом режиме. Этот режим не работает для игр, использующих одинарную буферизацию, что встречается редко.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Изменение цветового буфера&lt;/span&gt;: Этот параметр проверяет, был ли изменен буфер кадров. В некоторых играх это не работает.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1927"/>
        <source>Frame buffer swap on:</source>
        <translation>Замена буфера кадра на:</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Некоторые эмуляторы плохо справляются с определением того, когда читать/писать буферы кадров. Вы можете отключить помощь эмулятора, чтобы позволить GLideN64 читать/писать буферы кадров самостоятельно.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Обычно выключено, но для некоторых игр/эмуляторов может быть быстрее включено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="1977"/>
        <source>Use emulator help to read/write frame buffers</source>
        <translation>Использовать справку эмулятора для чтения/записи буферов кадров</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Если этот флажок установлен, цветовой буфер будет считываться по частям. В противном случае буфер будет считываться целиком. Если игре необходимо считывать весь буфер, выбор этого параметра может быть медленным.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Обычно выключено , поскольку цветовой буфер обычно считывается целиком&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translatorcomment>«Чтение» означает «Использовать справку эмулятора для чтения/записи буферов кадров»</translatorcomment>
        <translation>Считывать цветовой буфер блоками по 4 КБ</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Если отмечено, буфер глубины будет считываться по частям. В противном случае буфер будет считываться целиком. Если игре необходимо считывать весь буфер, выбор этого параметра может быть медленным.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено, поскольку буфер глубины часто не считывается полностью&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <extracomment>&quot;Read&quot; refers to &quot;Use emulator help to read/write frame buffers&quot;</extracomment>
        <translatorcomment>«Чтение» означает «Использовать справку эмулятора для чтения/записи буферов кадров»</translatorcomment>
        <translation>Чтение буфера глубины блоками по 4 КБ</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;В некоторых играх GLideN64 не может определить, когда игра использует буфер кадров. С помощью этих параметров вы можете заставить GLideN64 копировать каждый кадр буфера кадров вашей видеокарты в память N64.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Никогда&lt;/span&gt;: Отключить копирование буферов с видеокарты.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Синхронный&lt;/span&gt;: Эффекты обнаруживаются для всех игр, но это может быть медленно. Используйте для игр, где &lt;span style=&quot; font-weight:600;&quot;&gt;Асинхронный&lt;/span&gt; не работает.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Асинхронный&lt;/span&gt;: Эффекты обнаруживаются для большинства игр.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Обычно асинхронный&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2039"/>
        <source>Copy video card frame buffer to N64 memory:</source>
        <translation>Копировать буфер кадра видеокарты в память N64:</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Буфер глубины используется для эмуляции некоторых эффектов (например, корон):&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Никогда&lt;/span&gt;: буфер глубины отключен.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Из VRAM&lt;/span&gt;: буфер глубины вашей видеокарты копируется в память N64 каждый кадр, что может быть медленно в некоторых играх.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600;&quot;&gt;Программно&lt;/span&gt;: обычно быстрее, чем копирование из VRAM, но результат может быть неидеальным.&lt;/p&gt;&lt;p&gt;[Рекомендуется:&lt;span style=&quot; font-style:italic;&quot;&gt; Программно&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2095"/>
        <source>Copy video card depth buffer to N64 memory:</source>
        <translation>Копировать буфер глубины видеокарты в память N64:</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Когда эта опция включена, кадровый буфер отображается (рендерится) прямо на экран. Это предотвращает некоторые графические проблемы, но может привести к замедлениям или проблемам с качеством изображения.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Обычно выключено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2180"/>
        <source>Render N64 frame buffer to output</source>
        <translation>Рендеринг буфера кадров N64 для вывода</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Этот параметр необходим для некоторых эффектов, зависящих от глубины затенения, таких как SSAO и глубина резкости.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot;стиль шрифта:курсив;&quot;&gt;только в том случае, если вы используете Reshade и вам нужны эффекты, зависящие от глубины&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2190"/>
        <source>Copy depth to main depth buffer</source>
        <translation>Копировать глубину в основной буфер глубины</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2247"/>
        <source>N64 textures</source>
        <translation>Текстуры N64</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Этот фильтр сглаживает или делает текстуры более резкими. Существует четыре фильтра сглаживания и два фильтра резкости. Чем выше число, тем сильнее эффект. Производительность может быть затронута в зависимости от игры и/или вашего ПК.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Ваши предпочтения&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
...
No texture enhancement</extracomment>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Можно выбрать 12 различных фильтров. В зависимости от того, какой фильтр, они могут вызывать проблемы с производительностью.&lt;/p&gt;&lt;p&gt;Когда выбрано &lt;span style=&quot; font-weight:600;&quot;&gt;Хранить&lt;/span&gt;, текстуры сохраняются в кэше как есть. Это повышает производительность в играх, которые загружают много текстур. Снимите флажок &lt;span style=&quot; font-weight:600;&quot;&gt;Отключить для фонов&lt;/span&gt; для лучшей производительности.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Ваши предпочтения&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2367"/>
        <source>Store</source>
        <extracomment>Store texture enhancement</extracomment>
        <translatorcomment>Хранилище улучшения текстур</translatorcomment>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция включает этап предварительной обработки, который уменьшает проблемы с постеризацией улучшенных текстур.&lt;/p&gt;&lt;p&gt;[Рекомендуется:&lt;span style=&quot;стиль шрифта:курсив;&quot;&gt; Включено для xBRZ&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2474"/>
        <source>Decrease color banding (recommended for xBRZ enhancement)</source>
        <translation>Уменьшить цветовые полосы (рекомендуется для улучшения xBRZ)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция пропускает улучшения текстур для длинных, узких текстур, которые обычно используются для фонов. Это может сэкономить текстурную память и улучшить производительность.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено, если только Улучшение не установлено в значение Хранить&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2484"/>
        <source>Disable for backgrounds</source>
        <translation>Отключить для фонов</translation>
    </message>
    <message>
        ...
        <translation>Использовать хранилище файлов вместо кэш-памяти</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2578"/>
        <source>Texture cache path:</source>
        <translation>Путь к кэшу текстур:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Путь к дампу текстуры:</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Улучшенные и отфильтрованные текстуры могут быть кешированы для повышения производительности. Эта опция регулирует, сколько памяти выделяется для кеша текстур. Это может улучшить производительность, если есть много запросов на одну и ту же текстуру, что обычно и происходит. Обычно 128 МБ должно быть более чем достаточно, но лучшая опция для каждой игры своя. Super Mario 64 может не требовать более 32 МБ, но Conker&apos;s Bad Fur Day может использовать 256 МБ+. Регулируйте соответственно, если у вас возникли проблемы с производительностью. Установка этой опции в 0 отключает кеш.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Зависит от ПК и игры&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Выберите путь к папке с пакетами текстур.&lt;br/&gt;По умолчанию: Plugin/hires_texture&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Если этот параметр отключен, текстуры будут загружены такими, какие они есть при использовании Rice Video: прозрачности включены или выключены. Если этот параметр выбран, GlideN64 проверит, как был разработан альфа-канал текстуры, и выберет наиболее подходящий формат. Это дает разработчикам пакетов текстур свободу использовать полупрозрачные текстуры.&lt;/p&gt;&lt;p&gt;Снимите этот флажок для старых или плохо разработанных текстурных пакетов.&lt;/p&gt;&lt;p&gt;[Рекомендуется:&lt;span style=&quot; font-style:italic;&quot;&gt; Зависит от пакета текстур&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2666"/>
        <source>Use full transparencies (recommended for newer texture packs)</source>
        <translation>Использовать полную прозрачность (рекомендуется для новых пакетов текстур)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция эмулирует ошибку расчета CRC палитры в Rice Video. Если у вас возникли проблемы с загрузкой текстур, попробуйте включить или выключить эту опцию.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;В основном выключено, включено для старых текстурных пакетов&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2676"/>
        <source>Alternative CRC calculation (for old Rice Video packs)</source>
        <translation>Альтернативный расчет CRC (для старых пакетов Rice Video)</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция сохраняет все ранее загруженные и улучшенные текстуры на вашем ПК. При следующем запуске игры текстуры не нужно создавать заново, что обеспечивает более плавную работу.&lt;/p&gt;&lt;p&gt;При использовании текстурных пакетов загрузка пакетов займет всего несколько секунд при запуске игры, в отличие от 5–60 секунд, которые обычно занимают загрузки. Однако, если вы измените текстурный пакет, вам придется вручную удалить кэш текстур. Сохраненные файлы кэша сохраняются в папке Cache в папке плагинов.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2801"/>
        <source>Save enhanced texture cache to hard disk</source>
        <translation>Сохранить улучшенный кэш текстур на жесткий диск</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Текстуры будут сжаты, чтобы в кэше можно было хранить больше текстур. Степень сжатия зависит от текстуры, но обычно сжатие составляет 1/5 от исходного размера.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Включено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Эта опция уменьшает вдвое место, используемое текстурами в кеше текстур и памяти видеокарты, чтобы улучшить производительность. При уменьшении количества цветов GLideN64 старается максимально сохранить исходное качество. На большинстве текстур это едва заметно, но некоторые текстуры, например, небо, могут выглядеть заметно хуже.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Выключено&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="configDialog.ui" line="2824"/>
        <source>Convert textures to 16 bpp</source>
        <translation>Конвертировать текстуры в 16 bpp</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Некоторые игры N64 используют гамма-коррекцию, чтобы осветлить изображение. Когда кадровый буфер включён, гамма-коррекция применяется автоматически для всех игр, которые используют её на N64. Вместо этого вы можете использовать собственную гамма-коррекцию с помощью этой опции. Уровень по умолчанию, используемый на N64, равен 2.&lt;/p&gt;&lt;p&gt;[Рекомендуется: &lt;span style=&quot; font-style:italic;&quot;&gt;Выключено; 2.00&lt;/span&gt;]&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отображение на экране</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Процент отображения</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отсутствует папка с пакетом текстур. Пожалуйста, измените папку или отключите пакеты текстур.</translation>
    </message>
    <message>
        ...
        <translation>Отсутствует папка кэша текстур-паков. Пожалуйста, измените папку или отключите текстур-паки.</translation>
    </message>
    <message>
        ...
        <translation>Отсутствует папка дампа текстур. Пожалуйста, измените папку или отключите дамп текстур-паков.</translation>
    </message>
    <message>
        <location filename="ConfigDialog.cpp" line="689"/>
        <source>Are you sure you want to reset all settings to default?</source>
        <translation>Вы уверены, что хотите сбросить все настройки до значений по умолчанию?</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translatorcomment>Сокращение для Герц; при необходимости добавьте начальный пробел</translatorcomment>
